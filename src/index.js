...
// I could handle the errors and use the solution
// above and close most of the tests, but this solution
// should not be used just like eval ().
...
function mathWithBrackets(array) {
  ...
  function fooMathWithNestedBrackets(arr) {
    ...
    const nestedBracketsArray = bracketsArray.slice(
      0,
      bracketsArray.indexOf(")")
    );
